...
> **Last reviewed:** 2026-06-25 (CG-16 tail @ `7593331` — `test_tui_command_path.py` de-mock + RISK-2 store seam)
...
| CG-16 | P1 | Fixed | Controller/TUI command-path tests use real stubs, not mock wiring | TICKET-14 / M-01 / RISK-2 | `test_tui_command_path.py` (0 `MagicMock`), `test_controller_persistence.py`, `test_chat_repl_displays_answer.py`; audit bootstrap via `_create_store()` |

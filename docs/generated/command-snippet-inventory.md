...
| `teaagent daily "summarize this repo" --dry-run --root . --human` | `README.md:47` (089a153a) | smoke | tests/test_cli_ergonomics_handlers.py |
| `teaagent daily "what I want to do today" --human` | `README.md:60` (2eb1b8cb) | smoke | tests/test_cli_ergonomics_handlers.py |
| `teaagent doctor aigateway` | `docs/USAGE.md:282` (5d4fb3df) | manual | AI gateway doctor smoke |
| `teaagent doctor mcp --wizard --root .` | `docs/USAGE.md:135` (59681397) | manual | MCP wizard smoke when MCP enabled |
| `teaagent doctor model claude` | `docs/USAGE.md:274` (97c53b40) | manual | Provider-dependent local smoke |
| `teaagent doctor model gpt` | `docs/USAGE.md:109` (a3e56c73) | manual | Provider-dependent local smoke |
| `teaagent doctor model gpt --wizard` | `docs/USAGE.md:280` (52f07f7e) | manual | Provider-dependent local smoke |
| `teaagent doctor model ollama` | `docs/USAGE.md:275` (ad4c3d52) | manual | Provider-dependent local smoke |
| `teaagent doctor model opencodezen` | `docs/USAGE.md:277` (35841458) | manual | Provider-dependent local smoke |
| `teaagent doctor model opencodezen-go` | `docs/USAGE.md:278` (58759ddc) | manual | Provider-dependent local smoke |
| `teaagent doctor model vllm` | `docs/USAGE.md:276` (ecad996b) | manual | Provider-dependent local smoke |
| `teaagent doctor model workers-ai` | `docs/USAGE.md:279` (b502e22e) | manual | Provider-dependent local smoke |
| `teaagent doctor project --wizard --root .` | `docs/USAGE.md:286` (dd834a3f) | manual | Project doctor wizard smoke |
| `teaagent doctor providers --wizard` | `docs/USAGE.md:284` (2da4c979) | manual | Provider-dependent local smoke |
| `teaagent doctor providers --wizard --provider gpt --provider workers-ai --write-env --root .` | `docs/USAGE.md:285` (1cc7d1bf) | manual | Provider-dependent local smoke |
...
| `teaagent model smoke gpt --prompt "Reply with exactly: ok"` | `docs/USAGE.md:293` (39e44d39) | manual | Provider smoke with configured credentials |
...
| `teaagent run "summarize the test suite" --permission-mode read-only` | `README.md:61` (1a2f1708) | manual | Operator golden-path smoke before release |
| `teaagent run "summarize the test suite" --permission-mode read-only --root .` | `README.md:50` (cc26544c) | manual | Operator golden-path smoke before release |
...
| `teaagent setup --root . --provider gpt --permission-mode read-only --write-env` | `README.md:44` (96100884) | smoke | tests/acceptance/test_daily_cli.py |
...
| `teaagent tui --root . --permission-mode prompt` | `docs/USAGE.md:390` (a8e4a35a) | manual | Operator TUI smoke before release |

...
| M4 operator cockpit | CLI shared snapshot + TUI status panels exist (tabbed TUI screens deleted 2026-09-15 per owner G17, `1611e71b`) | Needs owner dogfood proof against M4 exit question; Q4 data (`memory.quarantine_count`) is in the CLI snapshot only | DR-006 carve-out (`owner-override`) | Acceptance matrix + v1 schema pins; 2026-09-17 post-G17 amendment. |

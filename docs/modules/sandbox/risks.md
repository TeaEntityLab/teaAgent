...
## R1: Git sandbox not available in detached HEAD
...
## R2: Stash pop may fail after merge conflicts
...
## R3: `_sandbox_lock` is module-level
...
## R6: Parallel experiment resource contention

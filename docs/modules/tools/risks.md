...
## R1: No output schema validation
**File**: `tools.py:50-79`
...
## R2: Rate limit uses wall-clock time, not monotonic
...
## R3: HookError from post-hook is not caught
...
## R4: Handler exceptions are not wrapped
**File**: `tools.py`
...
## R5: `ToolAnnotations.destructive=True` + `read_only=True` returns 'Critical'
**File**: `tools.py:64-76`

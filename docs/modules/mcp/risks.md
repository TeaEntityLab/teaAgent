...
## R1: MCP tool injection (untrusted server)
**File**: `mcp_trust.py`
...
## R2: `initialize()` not called guard
...
## R3: No connection timeout on MCP calls
...
## R4: MCP server does not validate tool output
**File**: `mcp_server.py`
...
## R6: `MCPToolAdapter` copies input_schema verbatim
...
## R7: `call_tool` HTTP error details truncated

...
## R2: Regex redaction is incomplete
**File**: `audit.py:48-67`
...
## R3: Disk error silently swallows events
...
## R5: `last_chain_hash` tail truncation
...
## R6: Thread-safety comment vs. reality
**File**: `audit.py:252`

...
## WST-R-001: Path traversal via symlinks
...
## WST-R-002: `workspace_edit_at_hash` race condition
...
## WST-R-003: Shell command injection through arguments
...
## WST-R-004: Write size limit bypassed by sequential writes
...
## WST-R-005: Knowledge backend failure silently degrades
...
## WST-R-006: gitignore matching is approximate

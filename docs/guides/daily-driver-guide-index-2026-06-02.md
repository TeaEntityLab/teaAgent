# Daily-Driver Guide Index
# 2026-06-02

This index groups the user-facing guide layer.
...
- [tui-chat-recipes-2026-06-02.md](tui-chat-recipes-2026-06-02.md)
- [../agent-mode-operator-guide.md](../agent-mode-operator-guide.md)
- [agent-mode-recipes-2026-06-02.md](agent-mode-recipes-2026-06-02.md)

## Trust and recovery

- [approval-recipes-2026-06-02.md](approval-recipes-2026-06-02.md)
- [recovery-recipes-2026-06-02.md](recovery-recipes-2026-06-02.md)
...
Users should not need the full audit corpus to decide what command to run. Use this
guide layer first, then jump into analysis or ticket plans only when debugging or
implementing.

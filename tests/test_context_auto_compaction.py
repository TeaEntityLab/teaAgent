...
def test_compaction_manager_auto_trigger() -> None:
    ...
    context = {
        'observations': [
            {'tool_name': f'tool_{i}', 'result': {'data': 'x' * 50}} for i in range(10)
        ]
    }
...
def test_compaction_manager_respects_interval() -> None:
...
def test_compaction_manager_disabled() -> None:
...
def test_compaction_manager_token_estimation() -> None:

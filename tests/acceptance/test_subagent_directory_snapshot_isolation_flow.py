...
class SubagentContainerIsolationFlowTests(unittest.TestCase):
    def test_subagent_tool_forwards_directory_snapshot_isolation(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(captured['isolation'], 'directory-snapshot')
            self.assertEqual(result['lineage']['isolation'], 'directory-snapshot')
            self.assertEqual(
                result['lineage']['container_path'],
                '.teaagent/subagent-snapshots/demo',
            )

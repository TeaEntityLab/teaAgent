...
CLI / TUI  →  AgentRunner (decision loop)  →  ToolRegistry  →  Workspace Tools
           ...
           (11 providers)                 (5 permission modes)
```
...
If you keep secrets in macOS Keychain, you can keep using
...
This keeps global defaults first, then secure keychain-loaded values, then
project-specific overrides last.

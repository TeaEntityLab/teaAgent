...
def assess_provider_portability(providers: list[ProviderProfile]) -> list[PortabilityResult]:
    ...
    for provider in providers:
        ...
        if provider.limits.get("max_context_tokens", 0) and provider.limits["max_context_tokens"] < 128000:

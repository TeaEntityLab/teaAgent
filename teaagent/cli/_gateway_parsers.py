...
def register(
    ...
    p_start.add_argument('--platform', action='append', default=[],
                         help='Platform to enable (telegram, slack, discord). Repeatable.')
    p_start.add_argument('--telegram-token', default='',
                         help='Telegram bot token (or TELEGRAM_BOT_TOKEN env).')
    p_start.add_argument('--slack-bot-token', default='',
                         help='Slack bot token (or SLACK_BOT_TOKEN env).')
    p_start.add_argument('--slack-app-token', default='',
                         help='Slack app token (or SLACK_APP_TOKEN env).')
    p_start.add_argument('--discord-token', default='',
    ...
    p_list.add_argument('--quiet', action='store_true', help='Only list platform names.')

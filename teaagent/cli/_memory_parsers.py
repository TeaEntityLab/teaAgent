...
def register(
    ...
    add.add_argument('--root', default='.', help='Workspace root. Defaults to current directory.')
    add.add_argument('--tag', action='append', default=[], help='Tag to attach. Can be repeated.')
    add.set_defaults(func=handlers['add'])

    lst = subs.add_parser('list', help='List recent memory entries.')
    lst.add_argument('--root', default='.', help='Workspace root. Defaults to current directory.')
    ...
    search.add_argument('--root', default='.', help='Workspace root. Defaults to current directory.')
    search.add_argument('--limit', type=int, default=10, help='Maximum memories to return.')
    ...
    show.add_argument('--root', default='.', help='Workspace root. Defaults to current directory.')

...
def register(
    ...
    p_submit = cloud_sub.add_parser('submit', help='Submit a task to a managed runtime.')
    p_submit.add_argument('name', help='Task name for identification.')
    p_submit.add_argument('task', help='Task prompt to execute.')
    p_submit.add_argument('--runtime', default='anthropic', help='Runtime backend (anthropic, openai, ...).')
    ...
    p_caps = cloud_sub.add_parser('capabilities', help='List available managed runtime capabilities.')

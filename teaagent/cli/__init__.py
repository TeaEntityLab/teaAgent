...
def build_parser() -> argparse.ArgumentParser:
    ...
    register_misc(
        subparsers,
        {
            ...
            'code_ontology_build': code_ontology_build,
            'code_ontology_query': code_ontology_query,
            ...
            'audit_decrypt': audit_decrypt_command,
            'audit_export': audit_export_command,
            'audit_show': audit_show_command,
            'audit_tail': audit_tail_command,
            ...
            'doctor_config_lint': doctor_config_lint_command,
            'doctor_selftest': doctor_selftest_command,
            'doctor_review_institution': doctor_review_institution,
            'env_provision': env_provision_command,
            'env_verify': env_verify_command,
            'env_lock': env_lock_command,
            'health': health_command,
            'surfaces_explain': surfaces_explain_command,
    ...
    register_consensus(
        subparsers,
        {
            ...
            'cancel': consensus_cancel_command,
        ...
        cast(
            dict[str, Callable[..., Any]],
            {
                ...
                'runs': {
                    ...
                    'review': agent_runs_review,
                    'commit': agent_runs_commit_command,
                },
                'chat': chat_command,
            },
        ),
    ...
    register_ergonomics(
        subparsers,
        {
            ...
            'approval_reject': approval_reject_command,
            ...
            'approval_why_denied': approval_why_denied_command,
            'approval_subagents_list': approval_subagents_list_command,
            'approval_subagents_approve': approval_subagents_approve_command,
            'approval_subagents_deny': approval_subagents_deny_command,
            'approval_subagents_approve_all': approval_subagents_approve_all_command,
            'approval_subagents_deny_all': approval_subagents_deny_all_command,
            'approval_subagents_prune': approval_subagents_prune_command,
            'cockpit_show': cockpit_show_command,
            'guidance': guidance_command,
            'permission_explain': permission_explain_command,

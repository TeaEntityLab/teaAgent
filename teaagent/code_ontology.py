...
class CodeOntologyGraph:
    ...
    def query_dependencies(self, entity_name: str, direction: str = 'both') -> list[dict[str, Any]]:
...
class CodeOntologyBuilder:
    ...
    def _parse_file(self, file_path: Path) -> None:
        ...
        try:
            ...
            visitor = CodeOntologyVisitor(str(file_path.relative_to(self.root)), module_id)
            visitor.visit(tree)

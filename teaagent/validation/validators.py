...
class ValidationRunner:
    ...
    def validate_file(self, file_path: Path) -> List[ValidationResult]:
        ...
        for tool in self.available_tools:
            try:
                ...
                import sys
                print(f"[TeaAgent] Warning: {tool} validation failed: {exc}", file=sys.stderr)
    ...
    def _parse_output(self, tool: str, stdout: str, stderr: str) -> tuple[List[ValidationError], List[ValidationError]]:
